...
def main():
    ...
    # 自动定位到当前脚本所在目录下的 RULER-main/scripts
    ruler_scripts = os.path.join(os.path.dirname(__file__), "RULER-main", "scripts")
    ruler_eval = os.path.join(ruler_scripts, "eval")

    if ruler_eval not in sys.path:
        sys.path.insert(0, ruler_eval)
