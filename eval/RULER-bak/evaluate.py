...
def main():
    ...
    import sys
    if '/root/cjh/pro/resources/datasets/RULER/scripts/eval' not in sys.path:
        sys.path.insert(0, '/root/cjh/pro/resources/datasets/RULER/scripts/eval')
    module = importlib.import_module(f"{args.benchmark}.constants")

    tasks_base = module.TASKS
    with open(os.path.join("/root/cjh/pro/resources/datasets/RULER/scripts", f"{args.benchmark}.yaml"), "r") as f:
