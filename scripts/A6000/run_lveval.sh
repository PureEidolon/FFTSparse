...
DATA_DIR="/backup01/cjh/projects/resources/datasets/LVEval"
...
#"hotpotwikiqa_mixup_32k"


tasks=("loogle_CR_mixup_16k" "hotpotwikiqa_mixup_16k" "loogle_CR_mixup_64k" "hotpotwikiqa_mixup_64k")

#tasks=("dureader_mixup_64k" "hotpotwikiqa_mixup_64k" "loogle_CR_mixup_64k")
